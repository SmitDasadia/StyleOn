          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <Link href={'/termofservice'} legacyBehavior>
                  <a className="text-gray-600 hover:text-gray-800"><li>Cookies & Usage</li></a>
                </Link>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <Link href={'/privacy'} legacyBehavior>
                  <a className="text-gray-600 hover:text-gray-800"><li>T-Shirt Guide</li></a>
                </Link>
                <Link href={'/shipping'} legacyBehavior>
                  <a className="text-gray-600 hover:text-gray-800"><li>Customer Services</li></a>
                </Link>
                <Link href={'/refund'} legacyBehavior>
                  <a className="text-gray-600 hover:text-gray-800"><li>Return & Exchanges</li></a>
                </Link>
