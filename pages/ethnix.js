                        ...
                        <div className=" max-w-md w-full mx-auto overflow-hidden">
                            ...
                            <div className="flex flex-col justify-center items-center py-6">
                                ...
                                <p className="text-gray-600 text-center px-4 mb-6">
                                    We are sorry, but Ehtinx are currently out of stock. Please check back later or contact us for more information.
                                </p>
                ...
                <section className="text-black body-font ">
                    ...
                    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                            <h1 className="text-4xl font-bold tracking-tight text-gray-900 ">Ethnix
                                <p className="text-xl leading-5 text-gray-600 font-medium py-2 px-2">{totalProducts} Ethnix</p>
                            </h1>
