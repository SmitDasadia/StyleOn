        ...
        <ul class="flex flex-wrap items-center mb-16">
          ...
          <li><a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#">Apple iPhone 12 PRO</a></li>
            ...
            <a class="h-30 block mb-4 sm:mb-12 mr-4 sm:mr-0" href="#">
              ...
              <svg width="12" height="8" viewbox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full sm:w-9/12 px-4">
                  <img class="mb-5" src="https://m.media-amazon.com/images/I/512JaQMamfL._UX679_.jpg" alt="" />
            ...
            <div class="w-full lg:w-1/2 px-4">
              <div class="max-w-md mb-6">
                <span class="text text-gray-400 tracking-wider">NO System is #UnHackable</span>
                <h2 class="mt-6 mb-4 text-xl md:text-xl lg:text-3xl font-heading font-medium">NO System is #UnHackable</h2>
                <h3 class="mt-6 mb-4 text-xl md:text-xl lg:text-3xl font-heading font-medium">Black/xl</h3>
                <p class="flex items-center mb-6">
                  <span class="text-3xl text-blue-500 font-medium">₹499.00</span>
                </p>
                <p class="text-lg text-gray-400">This T-Shirt is very good.</p>
              </div>
          ...
          <span class="text-md text-gray-400">4.59</span>
              ...
              <div class="Size mb-10">
                <h4 class="mb-3 font-heading font-medium">Size:</h4>
                <select class="w-24 px-3 py-2 text-center bg-white border-2 border-blue-500 outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl">
                  <option>S</option>
                  <option>M</option>
                  <option>L</option>
                  <option>XL</option>
              ...
              <div class="pincode mb-10">
                <h4 class="mb-3 font-heading font-medium">Pincode:</h4>
                <input onChange={onChangePinCode} class=" px-3 py-2 text-center bg-white border-2 border-blue-500 outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl" type="text" placeholder="Enter Your Pincode" /> <button
                  class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-xl" onClick={checkPincode}>
                  Check
                </button>
                {service && service != null && <div class="text-green-800">This Pincode is Servivceable!</div>}
                {!service && service != null && <div class="text-red-800">Sorry! This Pincode is not Servivceable!</div>}
              </div>
              <div class="flex flex-wrap -mx-2 mb-12">
                <div class="w-full md:w-2/3 py-3 px-2 mb-2 md:mb-0"><a class="block py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl" href="#">Buy Now</a></div>
                <div class="w-full md:w-2/3 py-3 px-2 mb-2 md:mb-0"><a class="block py-4 px-2 leading-8 font-heading font-medium tracking-tighter text-xl text-white text-center bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:bg-blue-600 rounded-xl" href="#">Add to Bag</a></div>
