        ...
        <div>
            ...
            <section className="text-black body-font ">
                <div className=" md:py-12 lg:px-20 md:px-6 py-9 px-4">
                    <p className=" text-sm leading-3 text-gray-600 font-normal mb-2">Home / SportsWear</p>
                    <div className=" flex justify-between items-center mb-4">
                        <h2 className=" lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 font-semibold">SportsWear</h2>
                    ...
                    <p className=" text-xl leading-5 text-gray-600 font-medium">{totalProducts} SportsWear</p>
